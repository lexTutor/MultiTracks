...
<body class="premium standard u-fix-fancybox-iframe">
    <form runat="server">
        ...
        <div id="emptyContent" runat="server" class="wrapper mod-standard mod-gray">
            <p>
                We don't know about that artist please try again.
            </p>
        </div>

        <div id="artistContent" runat="server" class="wrapper mod-standard mod-gray">

            <div class="details-banner">
                <div class="details-banner--overlay"></div>
                <div class="details-banner--hero">
                    <asp:Image ID="artistBannerImage" runat="server" class="details-banner--hero--img" />
                </div>
            ...
            <div class="discovery--container u-container">
                <main class="discovery--section">
                                ...
                                <ul id="playlist" class="song-list mod-new mod-menu">
                                    <li class="song-list--item media-player--row">
                                        ...
                                        <div class="song-list--item--right">
                                            ...
                                            <a class="song-list--item--secondary"><%# Convert.ToDouble(Eval("BeatsPerMinute")).ToString("0.#") %> BPM</a>
                                            <a class="song-list--item--secondary"><%# Eval("FeatureCount") %>/6</a>
                                            ...
                                            <div class="media-item">
                                                <a class="media-item--img--link" href="#" tabindex="0">
                                                    <img class="media-item--img"
                                                        alt='<%# Eval("AlbumTitle") %>'
                                                        src='<%# Eval("AlbumImage") %>'
                                                        srcset='<%# Eval("AlbumImage") %>, <%# Eval("AlbumImage") %> 2x'>
                                                    <span class="image-tag"><%# Eval("AlbumYear") %></span>
                                                </a>
                                                <a class="media-item--title" href="#" tabindex="0"><%# Eval("AlbumTitle") %></a>
                                                <a class="media-item--subtitle" href="#" tabindex="0">
                                                    <div><%# Eval("AlbumArtist") %></div>
                                                </a>
                                            </div>
                    ...
                    <section id="biography" class="standard--holder">
                        <asp:FormView runat="server" ID="BiographyFormView">
                            <ItemTemplate>
                                <div class="discovery--section--header">
                                    <h2>Biography</h2>
                                </div>
                                <div class="artist-details--biography biography">
                                    <%# Eval("ArtistBiography") %>
                                    <p>
                                        <a href="#">Read More...</a>
                                    </p>
                                </div>
